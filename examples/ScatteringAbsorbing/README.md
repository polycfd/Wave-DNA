This is a quick example demonstrating that the domain boundary can either be scattering (waves are reflecting) or absorbing (waves can pass the domain). Here, the setup is as follows:
