...
t,p = _read(filename)
plt.plot(t,p, linewidth=2.0, color='black', linestyle='solid', label=r'$\mathrm{simulation\:nonlinear\:wave}$')


plt.xlabel('$f_{\mathrm{a}}t$', fontsize=fontsize)
plt.ylabel('$p_1/\Delta p_{\mathrm{a}}$', fontsize=fontsize)
plt.legend(loc='upper center', frameon=False, ncol=1, fontsize=fontsize, bbox_to_anchor=[0.5, 1.4])
plt.ylim(0.9,1.2)
plt.xlim(7,15)
...
plt.grid()
#plt.savefig("../../figures/horizon_equivalentAWH_nonlin.pdf", bbox_inches = "tight", dpi=400)
#plt.close()
plt.show()
