...
t,p = _AWH_analytical_O1(t,He)
plt.plot(t,p, linewidth=2.0, color='blue', linestyle='dotted', label=r'$\mathrm{analytical\:linear\:wave}\:\mathcal{O}\left(t^1\right)$')

t,p = _AWH_analytical_O2(t,rh,la,fa)
plt.plot(t,p, linewidth=2.0, color='blue', linestyle='dashed', label=r'$\mathrm{analytical\:linear\:wave}\:\mathcal{O}\left(t^2\right)$')
...
plt.yticks([0.9,1.0,1.1,1.2], ['$0.9$', '$1.0$', '$1.1$', '$1.2$'], fontsize=fontsize)

plt.grid()
#plt.savefig("../../figures/horizon_equivalentAWH.pdf", bbox_inches = "tight", dpi=400)
#plt.close()
plt.show()
