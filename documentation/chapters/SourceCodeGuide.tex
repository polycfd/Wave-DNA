...
{\tt memoryalloc.c} & Function to allocate memory for fields of the type {\tt struct DNA\_Field}  and the probe sample points and vectors. \\
...
{\tt solvesumaphi.c} & Routine calling the functions in {\tt fdsumaphi.c} to compute the sums over the previous time steps required for the explicit finite difference approximations of the time-derivatives. \\
