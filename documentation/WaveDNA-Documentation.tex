...
\begin{titlepage}
  \begin{center}
    ...
    % Title
    \HRule \\[0.4cm]
    {\huge Wave-DNA}\\[0.05cm] {\large (Wave Doppler effects in Nonlinear Acoustics)}\\[0.1cm]
    \HRule \\[2cm]
...
\input{chapters/AboutWaveDNA.tex}
\input{chapters/UsingWaveDNA.tex}
\input{chapters/SourceCodeGuide.tex}
